...
exports.VendorResolver = exports.VendorResponse = exports.VendorInput = void 0;
const Vendor_1 = require("../entities/Vendor");
const type_graphql_1 = require("type-graphql");
const user_1 = require("./user");
const Authenticate_1 = require("../middleware/Authenticate");
const User_1 = require("../entities/User");
let VendorInput = class VendorInput {
};
__decorate([
    type_graphql_1.Field(),
    __metadata("design:type", String)
], VendorInput.prototype, "name", void 0);
VendorInput = __decorate([
    type_graphql_1.InputType()
], VendorInput);
exports.VendorInput = VendorInput;
...
let VendorResolver = class VendorResolver {
    vendors({ em }) {
        return __awaiter(this, void 0, void 0, function* () {
            const vendors = em.find(Vendor_1.Vendor, {});
            return vendors;
        });
    }
    vendor(id, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield conn.execute(`select v.*, json_build_object('username', u.username) "createdBy", json_build_object('username', z.username) "modifiedBy" from vendor v left join public.user u on u.id = v.created_by_id inner join public.user z on z.id = v.modified_by_id where v.id = '${id}'
    `);
    ...
    updateVendor(id, name, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            const vendor = yield em.findOne(Vendor_1.Vendor, { id });
            if (!vendor) {
                return null;
            }
            if (!name) {
    ...
    deleteVendor(id, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield em.nativeDelete(Vendor_1.Vendor, { id });
            return vendor;
        });
    }
};
...
__decorate([
    type_graphql_1.Mutation(() => VendorResponse, { nullable: true }),
    type_graphql_1.UseMiddleware(Authenticate_1.Authenticate),
